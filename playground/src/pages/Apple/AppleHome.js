...
//         videoImageCount: 300,
//         imageSequence: [0, 299],
//         canvas_opacity: [1, 0, { start: 0.9, end: 0.96 }],
...
//         videoImageCount: 960,
//         imageSequence: [0, 959],
//         canvas_opacity_in: [0, 1, { start: 0, end: 0.12 }],
...
//         messageB_opacity_out: [1, 0, { start: 0.55, end: 0.63 }],
...
//     const scrollHeight = sceneInfo[currentScene].scrollHeight;
//     const scrollRatio = currentYOffset / scrollHeight; // yOffset - prevScrollHeight / 현재 씬의 scrollHeight
...
//     scrollLoop();
//   });
//   // window.addEventListener("DOMContentLoaded", setLayout); // 하단의 load 와 다른 점은 DOM 이 로드 되면 이미지가 아직 안불러와져도 실행해준다. 좀 더 빠름.
